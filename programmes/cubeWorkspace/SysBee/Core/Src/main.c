...
int8_t message[40]; //AVIRER
int8_t commande[10];
uint8_t scan_abeilles_flag = 0;
uint8_t calcul_trafic_flag = 0;

uint8_t capteur_ext; //AVIRER
uint8_t capteur_int;
uint8_t buffer_capteur_ext[69]; //avirer
uint8_t buffer_capteur_int[69];
/* USER CODE END PV */
